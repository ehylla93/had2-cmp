...
Therefore visit our clan [website](https://rprclan.com) and download latest missions.
...
- **cmp_Maplist.txt** Replace or add to the coop section of your mpmaplist.txt (only if you want to run your own server)

- **cmp_hints.txt** Some important hints to successfully end some of the missions

- **cmp_dialogs.txt** List of changes made to dialogs_DD.bin (for modders only)

- **cmp_changelog.txt** CMP changelog

- **cmp_logo.png** CMP logo

- **cmp_models.txt** List of modified model files

- **cmp_texty.txt** List of new string in TEXTY_DD.txt

- **hd2_models.ods** List of HD2 models
...
|Br(Gestapo)X3|		by Rs_sabre / ProSabre|
...
|Li2(Dead-End)			|by |
|Li2(Race)		        |by Sasha  Sqdn. Ldr. Ted Striker|
...
|Af(Skyrace)		    |by Sqdn. Ldr. Ted Striker|
